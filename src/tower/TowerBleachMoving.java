...
/**
 * A <code>TowerBleachMoving</code> object represents a Bleach tower icon drawn
 * to follow the mouse.
 * 
 ...
 */
public class TowerBleachMoving extends Tower
{
	// Fields
	private int price;
	...
	/**
	 * TowerBleachMoving constructor. Objects built of this class will have
	 ...
	 */
	public TowerBleachMoving(GameState state, int x, int y, int price)
	{
		super(state, x, y);
		this.price = price;
		name = "bleach.png";
	...
	public void update(double timeElapsed)
	{
		...
		if (distanceToPath > 40)
		{
			...
			if (state.isMouseClicked())
			{
				...
				{
					state.addGameObject(new TowerBleach(state, position.x, position.y));
				}
